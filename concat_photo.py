...
def data_generator(dir, list, args):
	...
	# for i in range(0x4E00, 0x4E01):
		if os.path.isfile(os.path.join(path_a,i)) and os.path.isfile(os.path.join(path_b,i)):
			im_a = Image.open(path_a+'/'+i)
			...
			new_im.save('img/'+path_output+'/'+dir+'/'+i)

if __name__ == '__main__':
	parser = argparse.ArgumentParser(description="Cancat image A and B")
	parser.add_argument("--path_a", default="img/meiryo")
	parser.add_argument("--path_b", default="img/ShigotoMemogaki-Regular-1-01")
	parser.add_argument("--img_size", default=128, type=int)
	parser.add_argument("--path_output", default="concat")
